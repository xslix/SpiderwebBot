skills = ["Атлетика", "Драка", "Фехтование", "Стрельба", "Запугивание", "Оккультизм", "Шестое чувство", "Бдительность", "Обращение", "Расследование", "Красноречие", "Исполнение", "Хитрость", "Эмпатия", "Этикет", "Законы", "Политика", "Финансы", "Лидерство", "Уличное", "Воровство", "Скрытность", "Выживание", "Ремесло", "Вождение", "Гуманитарные", "Естественные", "Медицина", "Информатика", "Электроника"]
